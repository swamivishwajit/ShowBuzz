<div class="header">
  ...
  <div class="container col-md-12">
				<div class="header-top-left">
					<p><a href="support.html">24/7 Customer Care</a> | <a class="play-icon popup-with-zoom-anim" href="#small-dialog"> Resend Booking Confirmation</a> </p>
                    ...
                    <div class="col-md-8" style="border-right: 1px dotted #C2C2C2;padding-right: 30px;">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="Registration">
                                <form action="${pageContext.request.contextPath}/userRegister" method="POST" role="form" class="form-horizontal">
                                <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label">
                                        Name</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label">
                                        Hint Question</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" name="hQuestion">
                                                    <option selected="selected">What is your pet’s name?</option>
                                                    <option>Which sports do u play? </option>
                                                	...
                                                	<option>What was your childhood nickname?</option>
                                                	 <option>What is the first name of the person you first had crush?</option>
                                                </select>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                    <label for="mobile" class="col-sm-2 control-label">
                                        Your Answer</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="hAnswer" placeholder="Answer">
                                    </div>
                                </div>
...
$('#myModal').modal('show');
  ...
  <!--hiiiiiiii-->
				<div class="logo">
					<a href="index.html"><h1>Show Buzz</h1></a>
				</div>
				<div class="search">
					<div class="search2">
					  <form>
